...
CUDA_VISIBLE_DEVICES=$gpu python ../test_general_seg.py -t /home/datumx/data_science_experiments/3D_data/data/S3DIS/prepare_label_rgb/val_files_Area_$area.txt -t /home/datumx/data_science_experiments/3D_data/data/S3DIS/prepare_label_rgb/val_files_Area_${area}.txt -l $ckpt -m pointcnn_seg -x $setting -r $repeat $save_ply
